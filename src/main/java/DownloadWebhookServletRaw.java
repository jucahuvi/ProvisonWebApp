...
@WebServlet("/downloadwebhookraw")
public class DownloadWebhookServletRaw extends HttpServlet {
...
public void writeToFile (String webhookPayload,HttpServletResponse response){
        ...
        try {
            ...
            webhookFile = new File("webhook_raw.txt");
            ...
            CloudBlobContainer container = blobClient.getContainerReference("webhookblobraw");

            // Define the path to a local file.
            final String filePath =  "webhook_raw.txt";

            CloudBlockBlob blob = container.getBlockBlobReference(filePath);

            File source = new File(filePath);
blob.deleteIfExists();
            blob.uploadFromFile("webhook_raw.txt");

                System.out.println("File upload to blob container");
                String fileNameToDownload = "webhook_raw" + (LocalDateTime.now().format(DateTimeFormatter.ISO_LOCAL_DATE)).toString() + ".txt";
